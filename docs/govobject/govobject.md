...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in sparks Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return a hex string that can be used in sparksd CLI
####  `serialize`
Return a hex string
####  `inspect`
...
var jsonProposal = {
  ...
  url:"http://www.sparkspay.io/proposal/first_proposal"
};
...
```javascript
proposal.url="http://www.sparkspay.io/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://www.sparkspay.io/fixedUrl"
