...
For detailed technical information about a block please visit [Blocks](https://sparks-docs.github.io/en/glossary/block) on the Sparks Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://sparks-docs.github.io/en/developer-reference#block-headers) page on the Sparks Developer Reference Wiki.
