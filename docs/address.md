# Sparks Address
Represents a Sparks address. Addresses are the most popular way to make Sparks transactions. See [the Sparks documentation](https://sparks-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/sparkspay/bitcore-sparks/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/sparkspay/bitcore-sparks/tree/master/lib/errors/spec.js).
