...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bitcore-lib-sparks found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of sparkscore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._sparkscore);
global._sparkscore = bitcore.version;
...
bitcore.SimplifiedGNList = require('./lib/deterministicgnlist/SimplifiedGNList');
bitcore.SimplifiedGNListDiff = require('./lib/deterministicgnlist/SimplifiedGNListDiff');
bitcore.SimplifiedGNListEntry = require('./lib/deterministicgnlist/SimplifiedGNListEntry');
