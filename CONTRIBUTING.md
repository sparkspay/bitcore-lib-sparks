...
- https://www.sparks.org/forum (Support Forum)
...
#### T3 - Require 'sparkscore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the sparkscore object.

DO:
```javascript
var sparkscore = require('../');
var PublicKey = sparkscore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add sparksevo git@github.com:sparkspay/bitcore-lib-sparks.git
git pull --rebase sparksevo master
```
...
```
Finally go to [github.com/sparkspay/bitcore-lib-sparks](https://github.com/sparkspay/bitcore-lib-sparks) in your web browser and issue a new pull request.
...
[github.com/sparkspay/bitcore-lib-sparks/issues](https://github.com/sparkspay/bitcore-lib-sparks/issues).
